...
\caption{Vehicular Network Architecture}%todo source
\end{figure}
\end{frame}
...
\caption{High Speed CAN Network}%Quelle
\end{figure}
\end{frame}
...
\caption{Low Speed CAN Network}%Quelle
\end{figure}
\end{frame}
...
\caption{Levels on the CAN bus}%Quelle
\end{figure}
\end{frame}
...
\caption{Bit stuffing technique}%Quelle
\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{Format of standard data frames}%Quelle
	\end{figure}
	\begin{itemize}
...
\begin{frame}
	...
	\end{itemize}
		...
		\begin{figure}
		\includegraphics[width=.5\textwidth]{filtering.png} 
